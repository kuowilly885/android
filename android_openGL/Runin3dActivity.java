...
public class Runin3dActivity extends Activity {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            if (mContextSupportsCubeMap) {
                int[] cubeMapResourceIds = new int[] {
                        R.drawable.skycubemap0, R.drawable.skycubemap1, R.drawable.skycubemap2,
                        R.drawable.skycubemap3, R.drawable.skycubemap4, R.drawable.skycubemap5};
            ...
            for (int face = 0; face < 6; face++) {
                ...
                try {
                    ...
                    try {
						...
						RunInLogUtil.writeLog(TAG, "Could not decode texture for face : " + Integer.toString(face));
                    }
                }
    ...
    private class Grid {
        ...
        final int VERTEX_SIZE = 6 * FLOAT_SIZE;
        final int VERTEX_NORMAL_BUFFER_INDEX_OFFSET = 3;
